...
public class NetUtil {
    ...
    public static String getNetWorkTypeString(Context context) {
        String netWorkTypeString = "未知网络";
        if (getNetworkType(context) == 6) {
            netWorkTypeString = "4G";
        } else if (getNetworkType(context) == 5) {
            netWorkTypeString = "3G";
        } else if (getNetworkType(context) == 4) {
            netWorkTypeString = "2G";
        } else if (getNetworkType(context) == 3) {
            netWorkTypeString = "wifi";
        } else if (getNetworkType(context) == 2) {
            netWorkTypeString = "以太网";
        } else if (getNetworkType(context) == 1) {
            netWorkTypeString = "网络断开或关闭";
        } else if (getNetworkType(context) == 0) {
            netWorkTypeString = "没有网络连接";
        }
